...
Search, copy, and save your [Gather](https://gatherit.app) design references without leaving the keyboard.
...
- **Save to Gather** — save a link from your clipboard (or paste one) into Gather; previews and tags are generated automatically.
